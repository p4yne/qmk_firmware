...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LVL1_] = LAYOUT(KC_TRNS, KC_TRNS, TO(_LVL0_),
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS),
                    
  [_LVL2_] = LAYOUT(KC_TRNS, TO(_LVL0_), KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS),

  [_LVL3_] = LAYOUT(TO(_LVL0_), KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS),

  [_LVL4_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, TO(_LVL0_),
                    KC_TRNS, KC_TRNS, KC_TRNS),

  [_LVL5_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, TO(_LVL0_), KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS),
                   
  [_LVL6_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    TO(_LVL0_), KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS),

  [_LVL7_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, TO(_LVL0_)),

  [_LVL8_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, TO(_LVL0_), KC_TRNS),

  [_LVL9_] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS,
                    KC_TRNS, KC_TRNS, KC_TRNS,
                    TO(_LVL0_), KC_TRNS, KC_TRNS)
};
  ...
  for (int i=0; i<MATRIX_COLS*MATRIX_ROWS;i++) {
    ...
    if (key == KC_TRNS) {
      if (rgb_matrix_get_flags() != LED_FLAG_ALL){
        ...
        set_led_color_by_hsv(i, C_HSV_WINERED);
      }
    } else {
